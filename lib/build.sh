...
${nuget_cmd} install src/GetIntoTeachingApi.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/GetIntoTeachingApi.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/GetIntoTeachingApi.Client.dll \
-recurse:'src/GetIntoTeachingApi.Client/*.cs' \
-doc:bin/GetIntoTeachingApi.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/GetIntoTeachingApi.Client.dll was created successfully"
fi
