...
{
    /// <summary>
    /// TeachingEventRegistrationRequest
    /// </summary>
    [DataContract]
    public partial class TeachingEventRegistrationRequest :  IEquatable<TeachingEventRegistrationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeachingEventRegistrationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeachingEventRegistrationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeachingEventRegistrationRequest" /> class.
        /// </summary>
        /// <param name="candidateId">Set to register an existing candidate for a teaching event..</param>
        ...
        public TeachingEventRegistrationRequest(Guid? candidateId = default(Guid?), string firstName = default(string), string lastName = default(string), string email = default(string), string telephone = default(string), string addressPostcode = default(string), CandidatePrivacyPolicy privacyPolicy = default(CandidatePrivacyPolicy))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for TeachingEventRegistrationRequest and cannot be null");
            }
            else
            {
            ...
            if (lastName == null)
            {
                throw new InvalidDataException("lastName is a required property for TeachingEventRegistrationRequest and cannot be null");
            }
            else
            {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for TeachingEventRegistrationRequest and cannot be null");
            }
            else
            {
                this.Email = email;
            ...
            {
                throw new InvalidDataException("addressPostcode is a required property for TeachingEventRegistrationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("privacyPolicy is a required property for TeachingEventRegistrationRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Set to register an existing candidate for a teaching event.
        /// </summary>
        /// <value>Set to register an existing candidate for a teaching event.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeachingEventRegistrationRequest {\n");
        ...
        {
            return this.Equals(input as TeachingEventRegistrationRequest);
        }

        /// <summary>
        /// Returns true if TeachingEventRegistrationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TeachingEventRegistrationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeachingEventRegistrationRequest input)
        {
            if (input == null)
                return false;
